...
create_ancestor_species <- function(landscape, config) {
  ...
  for(i in unique(landscape$environment[,"patch"])){
    ...
    new_species[[i]]$traits[ , "competition"] <-0.953846153846154 # stress the difference between c_c of 0.9 (lots of competition and little coexistence) and 0.99 (almost no competition thus lots of coexistence)
