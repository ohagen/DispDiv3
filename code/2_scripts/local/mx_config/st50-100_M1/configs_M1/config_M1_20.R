...
create_ancestor_species <- function(landscape, config) {
  ...
  for(i in unique(landscape$environment[,"patch"])){
    ...
    new_species[[i]]$traits[ , "dispersal"] <-0.4
    new_species[[i]]$traits[ , "competition"] <-0.91 # stress the difference between c_c of 0.9 (lots of competition and little coexistence) and 0.99 (almost no competition thus lots of coexistence)
...
divergence_threshold =10# 83 # between 10 and 50 ? as 0.1 to 0.5 Myrs or 100 - 500 kyrs
